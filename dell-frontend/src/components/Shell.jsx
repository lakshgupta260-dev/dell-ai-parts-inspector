...
export default function Shell() {
  ...
  return (
    <div style={{ position: "relative", zIndex: 2, minHeight: "100vh", background: T.bg, color: T.ink, transition: "background-color .3s, color .3s" }}>
      <header style={{ position: "sticky", top: 0, zIndex: 10, background: mode === "night" ? "rgba(10,15,28,0.72)" : "rgba(255,255,255,0.82)", backdropFilter: "blur(12px)", borderBottom: `1px solid ${T.line}`, transition: "background-color .35s, border-color .35s" }}>
